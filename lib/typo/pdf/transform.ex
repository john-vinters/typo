...
defmodule Typo.PDF.Transform do
  ...
  """
  @spec scale(number()) :: Types.transform_matrix()
  ...
  """
  @spec scale(number(), number()) :: Types.transform_matrix()
  ...
  """
  @spec skew(number(), number()) :: Types.transform_matrix()
  ...
  """
  @spec translate(number(), number()) :: Types.transform_matrix()
